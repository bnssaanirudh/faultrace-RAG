      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {CAPABILITIES.map((cap, idx) => (
            <div key={idx} className="p-8 rounded-xl bg-black border border-white/10 hover:border-white/20 transition-colors group">
              <cap.icon className="w-8 h-8 text-slate-500 mb-6 group-hover:text-neon transition-colors" />
